...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.src_uri'
        db.add_column('layerindex_recipe', 'src_uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Recipe.depends'
        db.add_column('layerindex_recipe', 'depends',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.src_uri'
        db.delete_column('layerindex_recipe', 'src_uri')

        # Deleting field 'Recipe.depends'
        db.delete_column('layerindex_recipe', 'depends')
