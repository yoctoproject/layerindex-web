...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.updated'
        db.add_column('layerindex_machine', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'LayerItem.updated'
        db.add_column('layerindex_layeritem', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Recipe.updated'
        db.add_column('layerindex_recipe', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Branch.updated'
        db.add_column('layerindex_branch', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'LayerBranch.updated'
        db.add_column('layerindex_layerbranch', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.updated'
        db.delete_column('layerindex_machine', 'updated')

        # Deleting field 'LayerItem.updated'
        db.delete_column('layerindex_layeritem', 'updated')

        # Deleting field 'Recipe.updated'
        db.delete_column('layerindex_recipe', 'updated')

        # Deleting field 'Branch.updated'
        db.delete_column('layerindex_branch', 'updated')

        # Deleting field 'LayerBranch.updated'
        db.delete_column('layerindex_layerbranch', 'updated')
