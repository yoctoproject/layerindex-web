...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.section'
        db.alter_column('layerindex_recipe', 'section', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Recipe.bbclassextend'
        db.alter_column('layerindex_recipe', 'bbclassextend', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Recipe.summary'
        db.alter_column('layerindex_recipe', 'summary', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Recipe.section'
        db.alter_column('layerindex_recipe', 'section', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Recipe.bbclassextend'
        db.alter_column('layerindex_recipe', 'bbclassextend', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Recipe.summary'
        db.alter_column('layerindex_recipe', 'summary', self.gf('django.db.models.fields.CharField')(max_length=200))
