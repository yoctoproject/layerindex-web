...
class Recipe(models.Model):
    layerbranch = models.ForeignKey(LayerBranch)
    filename = models.CharField(max_length=511)
    filepath = models.CharField(max_length=511, blank=True)
    pn = models.CharField(max_length=255, blank=True)
    pv = models.CharField(max_length=255, blank=True)
    summary = models.CharField(max_length=511, blank=True)
    description = models.TextField(blank=True)
    section = models.CharField(max_length=511, blank=True)
    license = models.CharField(max_length=2048, blank=True)
    homepage = models.URLField(blank=True)
    bugtracker = models.URLField(blank=True)
    provides = models.CharField(max_length=2048, blank=True)
    bbclassextend = models.CharField(max_length=511, blank=True)
    src_uri = models.CharField(max_length=511, blank=True)
    depends = models.TextField(blank=True)
    inherits = models.CharField(max_length=511, blank=True)

    updated = models.DateTimeField(auto_now = True)
    blacklisted = models.CharField(max_length=511, blank=True)
