...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'RecipeUpstreamHistory', fields ['end_date']
        db.create_index('rrs_recipeupstreamhistory', ['end_date'])

        # Adding index on 'RecipeUpstreamHistory', fields ['start_date']
        db.create_index('rrs_recipeupstreamhistory', ['start_date'])


    def backwards(self, orm):
        # Removing index on 'RecipeUpstreamHistory', fields ['start_date']
        db.delete_index('rrs_recipeupstreamhistory', ['start_date'])

        # Removing index on 'RecipeUpstreamHistory', fields ['end_date']
        db.delete_index('rrs_recipeupstreamhistory', ['end_date'])
